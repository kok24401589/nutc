...
<table width=100% border="1">
    <tr align="center" style="font-size:36px;font-family:Microsoft JhengHei;">
        <td style="background-color:rgb(33,66,109);border:1px solid rgb(33,66,109);"><a style="color:white;" href="treemap">校</a></td>
        <td >
            <a href="treemap_department?value=資訊工程系">系</a>
        </td>
    </tr>
</table>
