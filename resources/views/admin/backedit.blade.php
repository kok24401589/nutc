...
<body>
    <div class="content">
        ...
        <table class="table table-hover table-bordered">
            <thead>
                <tr>
                    <th class="bg-primary text-center" colspan="20">校院系編輯</th>
                </tr>
                <tr>
                    <td colspan="20">
                        {{-- 資料測試 --}}
...
{{--                     @foreach($Field_name as $FN)
                    ...
                    <th class="text-center bg-success text-white" width="100">系所相似名稱</th>
            ...
            @if ($col->SYSTEM_TYPE == null or
                 ...
                 {{-- $col->COL_ICON == null or
                 $col->DEP_ICON == null or --}}
                 $col->ST_NUM == null or
                 $col->SS_NUM == null or
                 $col->COL_NUM == null or
                 $col->DEP_LIKE == null
            ...
            @endif
                ...
                <td>
                    ...
                    <input class="form-control" list="edit_College" name="edit_College" style="font-size:16px;"
                    value="{{$col->College}}">
                       <datalist id="edit_College" value="{{$col->College}}">
                ...
                <td>
                  ...
                  <input class="form-control" list="edit_DEP_SIMPLE" name="edit_DEP_SIMPLE" style="font-size:16px;"
                  value="{{$col->DEP_SIMPLE}}">
...
{{--                 <td>
                ...
                <input class="form-control" list="edit_ST_NUM" name="edit_ST_NUM" style="font-size:16px;"
                value="{{$col->ST_NUM}}">
                ...
                <td>
                    ...
                    <input class="form-control" list="edit_SS_NUM" name="edit_SS_NUM" style="font-size:16px;"
                    value="{{$col->SS_NUM}}">
                         <datalist id="edit_SS_NUM"value="{{$col->SS_NUM}}">
                ...
                <td>
                    ...
                    <input class="form-control" list="edit_COL_NUM" name="edit_COL_NUM" style="font-size:16px;"
                    value="{{$col->COL_NUM}}">
