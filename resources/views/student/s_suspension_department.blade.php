...
<div class="row" style="font-size:36px;font-family:Microsoft JhengHei;">
  ...
  <div class="col text-center" style="background-color:rgb(33,66,109);">
    <a href="s_suspension_department?value=學士班(日間)&year={{$nowyear}}" style="color:white;" >系</a>
  </div>
</div>
</div>
<script>
...
var value="學士班(日間)";
location.href="s_suspension_department?year={{$nowyear}}&value=" +value;
}
