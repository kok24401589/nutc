...
<div class="row" style="font-size:36px;font-family:Microsoft JhengHei;">
  <div class="col text-center" style="background-color:rgb(33,66,109);">
    <a href="s_suspension?year={{$nowyear}}" style="color:white;" >校</a>
  </div>
  <div class="col text-center" >
    <a href="s_suspension_college?year={{$nowyear}}">院</a>
  </div>
  <div class="col text-center" >
                    ...
                    <td align="left" style="width:70%;padding:5px;color:#6F7678">   
                        <ul>
                            ...
                            <li style="font-size:26px;">
                                {{$SYSTEM_TYPE->SYSTEM_TYPE}}：{{(int)$SYSTEM_TYPE->SP_SUM}}
                                <span style='font-size:15px'>(     
                               {{ (round($SYSTEM_TYPE->SPpi,3)*100) }}
                                 %)</span>
                            </li>
                            @endforeach
                        </ul>
                ...
                <tr>
                    <td align="left" style="width:70%;padding:5px;color:#6F7678">
                        <ul>
                            ...
                            <li style="font-size:26px;">
                                {{$SCH_SYS->SCH_SYS}}：{{(int)$SCH_SYS->SP_SUM}}
                                <span style='font-size:15px'>(
                                        {{(round($SCH_SYS->SPpi,3)*100)}}
                                %)</span>
                            </li>
                            @endforeach
                ...
                <tr>
                    <td align="left" style="width:70%;padding:5px;color:#6F7678">
                        <ul>
                            ...
                            <li style="font-size:26px;">
                                {{$College->COL}}：{{(int)$College->SP_SUM}}
                                <span style='font-size:15px'>(
                                  {{(round($College->SPpi,3)*100)}}
                            %)</span>
                            </li>
                            @endforeach
        ...
        <tr>
            <td align="center" style="font-size:3vw;">
                <div class="row" style="font-size:16px;font-family:Microsoft JhengHei;width:100%;padding:0%"> 
                    ...
                    <div class="col-md-6">
                        <p style="font-size:6vmin;font-weight:bold;">歷年國立技專院校休學率比較圖:</p>
